...
mysql 설치를 진행한다. http://dev.mysql.com/downloads/mysql * (LTS 버전을 선택한다.)

mysql 설치 중 오류를 오류가 발생하면 vs code 라이브러리 설치 구글 검색 : visual C++ Redistributable v14 (vc_redist.x64.exe) 필요

mysql 관련 프로그램을 설치한다. https://dev.mysql.com/downloads/workbench/
