...
# CEATE USER 'mbc'% IDENTIFIED BY 'Mbc320!!';
...
# GRANT select, insert ON LMS.* TO '알바'@'%;    < 알바생 권한 예시 >
#       READ    CREATE                
